...
The `valleybike` package includes a variety of utility functions for working with the ValleyBike data:
...
For more details on what these functions do and how to use them, please see the [manual](https://github.com/Amherst-Statistics/valleybike/blob/main/valleybike_1.0.0.pdf).
