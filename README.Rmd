...
[ValleyBike.org](https://www.valleybike.org/) utility functions. To be used in conjunction with the `valleybikeData` package (more details [here](https://github.com/Amherst-Statistics/valleybikeData)).
...
The package includes a variety of utility functions for working with the ValleyBike data:
...
For more details on what these functions do and how to use them, please see the [package manual](https://github.com/Amherst-Statistics/valleybike/blob/main/valleybike_0.0.1.pdf).
